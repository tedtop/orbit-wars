# =============================================================================
# Orbit Wars bot: graceful_sloth_v2
# v1 + engine-grounded targeting fixes: intervening-planet interception, segment-correct sun check, speed-accurate two-pass lead. ~75-80% vs starter.
#
...
def _decide(obs, config):
    """
    Graceful Sloth v2 — ambitious heuristic agent for Orbit Wars.
