# =============================================================================
# Orbit Wars bot: comet_wraith_v3
# graceful_sloth_v2's proven offense, plus two engine-grounded edges it lacks:
...
#      between arrivals and fail. v3 gangs up sources that LAND THE SAME TICK so
